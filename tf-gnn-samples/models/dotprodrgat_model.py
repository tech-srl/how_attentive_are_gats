...
from gnns import sparse_dotprodrgat_layer
from . import RGAT_Model


class DotProd_RGAT_Model(RGAT_Model):
    @classmethod
    ...
    def _apply_gnn_layer(self,
        ...
        return sparse_dotprodrgat_layer(
            ...
            share_weights=self.params['share_weights']
        )
